...
const Index = () => {
  ...
  const rooms = [
    {
      title: "Deluxe Room",
      description: "Our spacious deluxe rooms feature modern amenities and elegant decor, perfect for a comfortable stay.",
      price: 150,
    ...
    },
    {
      ...
      description: "Indulge in luxury with our executive suite offering a separate living area and premium amenities for an unforgettable stay.",
      price: 250,
    ...
    {
      title: "Family Suite",
      description: "Perfect for families, this spacious suite features two bedrooms, ensuring comfort and privacy for everyone.",
      price: 320,
  ...
  const testimonials = [
    {
      ...
      rating: 5,
      text: "One of the best hotel experiences I've ever had. The service was exceptional and the rooms were immaculate. Will definitely come back!",
    },
    {
      name: "David Chen",
      location: "London, UK",
      rating: 5,
      text: "Excellent service, beautiful rooms, and the restaurant served some of the best food I've had during my travels. Highly recommended!",
    },
    {
      name: "Sophia Martinez",
      location: "Paris, France",
      rating: 4,
      text: "A truly luxurious experience. The staff went above and beyond to make our anniversary special. The amenities were perfect.",
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-gray-600 mb-4">
              Nestled in the heart of the city, Dotmot Hotel and Suite offers a perfect blend of luxury, comfort, and impeccable service. Our elegantly appointed rooms and suites are designed to provide you with the utmost comfort and relaxation during your stay.
            </p>
            <p className="text-gray-600 mb-4">
            ...
            <p className="text-gray-600 mb-6">
              Experience the perfect harmony of modern luxury and warm hospitality at Dotmot Hotel and Suite.
            </p>
        ...
        <div className="container mx-auto container-padding">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-xl mx-auto">
              Discover our range of luxurious accommodations designed for your comfort and relaxation.
            </p>
          </div>
      ...
      {/* Booking Section */}
      <section id="booking" className="section-padding bg-hotel bg-opacity-5">
        <div className="container mx-auto container-padding">
          <div className="text-center mb-12">
            <h2 className="hotel-heading text-3xl md:text-4xl font-bold mb-3">
            ...
            <div className="w-24 h-1 bg-hotel-gold mx-auto mb-6"></div>
            <p className="text-gray-600 max-w-xl mx-auto">
              Reserve your perfect room today and experience unparalleled luxury and service.
            </p>
          </div>
      ...
      <section id="contact" className="relative">
        <div className="grid grid-cols-1 lg:grid-cols-2">
          <div className="bg-hotel text-white p-8 md:p-12 lg:p-16">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p>123 Luxury Avenue, City Center, Country, 12345</p>
                </div>
              </div>
            </div>
          ...
          <div className="h-96 lg:h-auto">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d12345.67890!2d-73.987654!3d40.123456!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zNDDCsDA3JzAwLjQiTiA3M8KwNTknMDMuOSJX!5e0!3m2!1sen!2sus!4v1617123456789!5m2!1sen!2sus"
              width="100%"
              height="100%"
              style={{ border: 0 }}
